...
#     python3 loadForecast.py --ISO ISNE --load-rate $load_rate --verbose True
# done
...
#     done
# done
# python3 generationRA.py --ISO ISNE --load-rate high --vre-mix low --markov-cons 5 --verbose False


echo "---------------------- Running PfP Simulation ----------------------"
# python3 main.py --ISO ISNE --load-rate high --vre-mix low --markov-cons 10 --verbose False 
loads="high"
vres="high"
for vre in $vres; do 
    for load_rate in $loads; do 
